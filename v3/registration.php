		...
		<!-- Below  -->
            ...
            <div class="card-body row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" class="form-control" name="taxable_amount">
                </div>
                <div class="col-md-4">
...
<script>
    ...
    function addItem() {
        ...
        row.innerHTML = `
            ...
            <div class="col-md-3">
                <input type="number" step="0.01" class="form-control" name="items[${itemIndex}][total_price]" required>
            </div>
        `;
